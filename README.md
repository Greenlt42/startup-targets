...
startups in deep tech, climate, defence, energy, and biotech (pre-seed/seed/Series A,
backed by a top-tier VC) and surfaces them as targets to message.

Not LinkedIn scraping — pulls from public news/RSS feeds (Crunchbase News, TechCrunch,
Sifted, EU-Startups, etc.) and uses AI to extract structured fields from article text.
